...
#ifdef CONFIG_SND_AML_M1_MID_CS42L52
static int cs42l52_pwr_reset(void)
{
    //reset
    static int cs42l52_reset_io=0;
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_5, (1<<31));
    CLEAR_CBUS_REG_MASK(PERIPHS_PIN_MUX_6, (1<<9));
    set_gpio_val(GPIOE_bank_bit16_21(21), GPIOE_bit_bit16_21(21), 0); //low
    set_gpio_mode(GPIOE_bank_bit16_21(21), GPIOE_bit_bit16_21(21), GPIO_OUTPUT_MODE);

    udelay(20); 

    set_gpio_val(GPIOE_bank_bit16_21(21), GPIOE_bit_bit16_21(21), 1); //high
    set_gpio_mode(GPIOE_bank_bit16_21(21), GPIOE_bit_bit16_21(21), GPIO_OUTPUT_MODE);
    printk("cs42l52 reset IO value is  %x \n", cs42l52_reset_io);
    return 0;
}

static int CS42l52_POWER_DOWN_IO(void)
{
    set_gpio_val(GPIOE_bank_bit16_21(21), GPIOE_bit_bit16_21(21), 0); //low
    set_gpio_mode(GPIOE_bank_bit16_21(21), GPIOE_bit_bit16_21(21), GPIO_OUTPUT_MODE);
    return 0;
...
static struct cs42l52_platform_data cs42l52_pdata = {
    .is_hp_pluged = &is_hp_pluged,
    .cs42l52_pwr_rst = &cs42l52_pwr_reset,
    .cs42l52_power_down_io = &CS42l52_POWER_DOWN_IO,
    .spk_pwr_ctrl = 1,
    .hp_pwr_ctrl = 0,
    .spk_mono = 0,
    .master_vol = cs42l52_setting(0x06),
    .hp_vol = cs42l52_setting(0),
    .spk_vol = cs42l52_setting(0),
    .mic_ctrl = cs42l52_setting(0x30),
    .beep_tone_ctrl = cs42l52_setting(0x1F),
    .tone_ctrl = cs42l52_setting(0x37),
};
#endif
#ifdef CONFIG_SND_AML_M1_MID_WM8900
